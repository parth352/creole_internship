...
//  $pass =$row["password"];
   ...
   if($num_row==1){
      ...
      $key ="mykey12";
      $payload= array("id"=>$row['id'], "expire"=>time()+1200);
      ...
      if($password==$row['password']){
        ...
        $id = $row["id"];
        $sql_insert_acess_refresh_token= "INSERT INTO generate_token(user_id,access_token,refresh_token) VALUES('$id','$jwt_token','$jwt_refresh_token')";
        ...
        echo json_encode(array('message'=>'your password is invalid','status'=>false));
           }   
    }
    else{
