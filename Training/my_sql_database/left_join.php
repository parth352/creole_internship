<?php
    ...
    echo "<h1> This is example of left join Returns all the records from left table & matching values from right tables</h1>";
     $sql = "SELECT *
            FROM order_info
            LEFT JOIN employe_info ON order_info.employe_id=employe_info.employe_id;";
